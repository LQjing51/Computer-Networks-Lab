...
if __name__ == '__main__':
    ...
    #r1.cmd('route add -net 10.0.4.44 netmask 255.255.255.0 gw 10.0.2.2 dev r1-eth1')

    r2.cmd('ifconfig r2-eth0 10.0.2.2/24')
    r2.cmd('ifconfig r2-eth1 10.0.3.1/24')
    #r2.cmd('route add -net 10.0.4.44 netmask 255.255.255.0 gw 10.0.3.2 dev r2-eth1')
    #r1.cmd('route add -net 10.0.1.11 netmask 255.255.255.0 gw 10.0.2.1 dev r2-eth0')

    r3.cmd('ifconfig r3-eth0 10.0.3.2/24')
    r3.cmd('ifconfig r3-eth1 10.0.4.1/24')
    #r3.cmd('route add -net 10.0.1.11 netmask 255.255.255.0 gw 10.0.3.1 dev r3-eth0')
